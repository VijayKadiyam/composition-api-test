        ...
        <b-row>
          ...
          >
            <div class="d-flex">
              <b-button
                variant="primary"
                href="/observation-sheets/create"
              >
                <span class="text-nowrap">Add Observation Sheet</span>
              </b-button>
            </div>
          </b-col>
        </b-row>
      ...
      >
        ...
        <template #cell(actions)="data">
          ...
          >
            ...
            <b-dropdown-item :to="`/observation-sheets/${data.item.id}`">
...
export default {
  ...
  methods: {
    async getData() {
      this.items = []
      this.loading = true
      const items = await axios.get('/observation_sheets')
      this.items = items.data.data
      this.loading = false
    },
    async del(id) {
      const r = window.confirm('Are you sure you want to delete the data?')
      if (r) await axios.delete(`/observation_sheets/${id}`)
      this.getData()
    },
  },
}
