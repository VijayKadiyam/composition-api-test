        ...
        <b-row>
          ...
          >
            <div class="d-flex">
              <b-button
                variant="primary"
                href="/good-practices/create"
              >
                <span class="text-nowrap">Add Best Practice</span>
              </b-button>
            </div>
          </b-col>
        </b-row>
      ...
      >
        ...
        <template #cell(actions)="data">
          ...
          >
            ...
            <b-dropdown-item :to="`/good-practices/${data.item.id}`">
...
export default {
  ...
  methods: {
    async getData() {
      this.items = []
      this.loading = true
      const items = await axios.get('/good_practices')
      this.items = items.data.data
      this.loading = false
    },
    async del(id) {
      const r = window.confirm('Are you sure you want to delete the data?')
      if (r) await axios.delete(`/good_practices/${id}`)
      this.getData()
    },
  },
}
